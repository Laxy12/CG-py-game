...
font3 = pygame.font.Font('freesansbold.ttf',250)
...
barrel_time = 360
barrel_img = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/barrels/barrel.png'),(section_width * 1.5, section_height * 2))
flames_img = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/fire.png'),(section_width * 2, section_height))
barrel_side = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/barrels/barrel2.png'),(section_width * 2, section_height * 2.5))
dk1 = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/dk/dk1.png'),(section_width * 5, section_height * 5))
dk2 = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/dk/dk2.png'),(section_width * 5, section_height * 5))
dk3 = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/dk/dk3.png'),(section_width * 5, section_height * 5))
peach1 = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/peach/peach1.png'),(section_width * 2, section_height * 3))
peach2 = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/peach/peach2.png'),(section_width * 2, section_height * 3))
fireball = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/fireball.png'),(section_width * 1.5, section_height * 2))
fireball2 = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/fireball2.png'),(section_width * 1.5, section_height * 2))
standing = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/mario/standing.png'),(section_width * 2, section_height * 2.5))
jumping = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/mario/jumping.png'),(section_width * 2, section_height * 2.5))
running = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/mario/running.png'),(section_width * 2, section_height * 2.5))
climbing1 = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/mario/climbing1.png'),(section_width * 2, section_height * 2.5))
climbing2 = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/mario/climbing2.png'),(section_width * 2, section_height * 2.5))
hammer_stand = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/mario/hammer_stand.png'),(section_width * 2.5, section_height * 2.5))
hammer_jump = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/mario/hammer_jump.png'),(section_width * 2.5, section_height * 2.5))
hammer_overhead = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/mario/hammer_overhead.png'),(section_width * 2.5, section_height * 3.5))
hammer = pygame.transform.scale(pygame.image.load('D:/priojects pyt/donkey kong/assets/images/hammer.png'),(section_width * 2, section_height * 2))

#online available calutions of every platform
...
row1_top = start_y - 5 * slope #end of platform(easier for calculations)
...
victory = False
reset_game = False
# same copied part of bridges postions
...
class Barrel(pygame.sprite.Sprite):
   ...
   def check_fall(self):
      ...
      below = pygame.rect.Rect((self.rect[0],self.rect[1]+section_height),(self.rect[2],3))
      for lad in lads:
...
#again same (this is done because there's already exiting calculations of donkey kong levels)
class Bridge:
    ...
    def draw(self):
      line_width = 7
      platform_colour = (225, 51, 129)#('dark red') # donkey kong exact clour scheme
      for i in range (self.length):
         bot_coord = self.y_pos + section_height
         left_coord = self.x_pos + (section_width * i)
         mid_coord = left_coord + (section_width * .5)
         right_coord = left_coord + section_width 
         top_coord = self.y_pos
         #Drawing base for the platform
         pygame.draw.line(screen, platform_colour, (left_coord, top_coord),(right_coord, top_coord),line_width)
         pygame.draw.line(screen, platform_colour, (left_coord, bot_coord),(right_coord, bot_coord),line_width)
         pygame.draw.line(screen, platform_colour, (left_coord, bot_coord),(mid_coord, top_coord),line_width)
         pygame.draw.line(screen, platform_colour, (mid_coord, top_coord),(right_coord, bot_coord),line_width)
    #making colliding platform
      top_line = pygame.rect.Rect((self.x_pos, self.y_pos), (self.length * section_width, 2))
      #pygame.draw.rect(screen, 'blue',top_line) #just made it to find out where the barrels collide
      return top_line  
...
def draw_screen():   
   ...
   for bridge in bridges:
        bridges_objs.append(Bridge(*bridge))
        platforms.append(bridges_objs[-1].top)
        
   return platforms , climbers

def draw_extras():#lives,lvl,bonus text,peach,oil drum,barrels(stationary),donkey kong
   #for score and high score text copied due to spacing isuues
        ...
        if event.type == pygame.KEYUP:
            ...
            if event.key == pygame.K_DOWN:
                ...
                if player.climbing and player.landed:
                    player.climbing = False
    if victory:
        screen.blit(font3.render('VICTORY!', True, 'red'), (0, window_height/1.8))
        reset_game = True
        # active_level += 1
        lives += 1
        score += bonus
